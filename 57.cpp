//virtual function example + creating rule
#include <iostream>
#include <cstring>
using namespace std;
class CWH
...
/*rulefor virtual functions 
1.they cannot be statics 
2. they are accessed by object pointer 
3. virtual function can be a  friends of another class
4. a virtual function in base class might not be used 
5. if a virtual function is defined in a base class , there is no neccessity of redefining
